...
Tone: clear, professional, friendly. No jargon. No implementation details.
Language: English only.

FORMAT RULES (follow exactly):
1. Start with: *🚀 Weekly CS-Product Fixes — ${weekRange}*
2. One blank line, then a short 1-sentence intro.
3. Group issues by product area. Under each header, bullet points only:
...
Only include areas with content. No sub-headers.

4. End with exactly: #productfixes
